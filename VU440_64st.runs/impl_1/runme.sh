...
HD_PWD='/home/nakashim/proj-arm64/fpga/VU440-step4000/VU440_64st.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VU440_TOP.vdi -applog -m64 -stack 10000  -product Vivado -messageDb vivado.pb -mode batch -source VU440_TOP.tcl -notrace
